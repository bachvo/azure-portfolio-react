    ...
    return (
      <main>
        <section className="home p-5">
          ...
          <p className="home__section-description" dangerouslySetInnerHTML={createMarkup(this.state.introDescription)}></p>
        ...
        <section className="d-flex flex-column align-items-center p-5">
          ...
          <p className="home__section-description" dangerouslySetInnerHTML={createMarkup(this.state.aboutDescription)}></p>
        ...
        <section className="home__workexp d-flex flex-column align-items-center p-5">
          <h2>{this.state.workExpTitle}</h2>
          <p className="home__section-description">{this.state.workExpDescription}</p>
          <div className="row row-cols-1 row-cols-md-3">
            {this.state.workExpCards.map((item, key) => {
              return (
        ...
        <section className="home__projects d-flex flex-column align-items-center p-5">
          ...
          <p className="home__section-description">{this.state.projectDescription}</p>
          <div className="row row-cols-1 row-cols-md-3">
            {this.state.projectCards.map((item, key) => {
              return (
                <div key={key} className="col mb-4">
                  <div className="home__card card h-100">
                    <img src={item.imgSrc} className="card-img-top" alt=""/>
        ...
        <section className="home__contact d-flex flex-column align-items-center p-5">
          <h2>{this.state.contact}</h2>
          <div className="home__contact-items">
            {this.state.contactInfo.map((item) => {
              return (
                <div key={item.type} className="d-flex flex-column align-items-center">
                  <a href={item.href}><img src={item.imgSrc} height="50" alt={item.type}/>
                    {item.type}
                  </a>
                </div>
              );
