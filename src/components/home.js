  ...
  render() {
    return (
      <div>
        ...
        <section className="home d-flex flex-column align-items-md-start align-items-lg-center p-2 py-4 p-md-5">
        ...
        <section className="home__projects d-flex flex-column align-items-md-start align-items-lg-left p-2 py-4 p-md-5">
        ...
        <section className="d-flex flex-column align-items-md-start align-items-lg-center p-2 py-4 p-md-5">
          <div className="d-flex row row-cols-1 row-cols-md-3">
